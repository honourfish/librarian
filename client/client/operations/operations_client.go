...
type ClientService interface {
	...
	PutLibrarianUsernameUserUserCheckin(params *PutLibrarianUsernameUserUserCheckinParams, opts ...ClientOption) (*PutLibrarianUsernameUserUserCheckinOK, error)
...
/*
  PutLibrarianUsernameUserUserCheckin requests a book to be checked in by a user
*/
func (a *Client) PutLibrarianUsernameUserUserCheckin(params *PutLibrarianUsernameUserUserCheckinParams, opts ...ClientOption) (*PutLibrarianUsernameUserUserCheckinOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewPutLibrarianUsernameUserUserCheckinParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "PutLibrarianUsernameUserUserCheckin",
		Method:             "PUT",
		PathPattern:        "/librarian/{username}/user/{user}/checkin",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &PutLibrarianUsernameUserUserCheckinReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	for _, opt := range opts {
	...
	success, ok := result.(*PutLibrarianUsernameUserUserCheckinOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for PutLibrarianUsernameUserUserCheckin: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
